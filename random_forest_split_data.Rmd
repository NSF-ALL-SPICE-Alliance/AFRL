...
performance_cellcycle <- confusionMatrix(predictions,test_data$cell_cycle_and_proliferation_responses)
...
# Evaluate the performance of the model on the testing set
performance_celldeath <- confusionMatrix(predictions,test_data$cell_death_and_apoptosis_responses)
...
# Evaluate the performance of the model on the testing set
performance_dna_damage <- confusionMatrix(predictions,test_data$dna_damage_and_repair_responses)
...
# Evaluate the performance of the model on the testing set
performance_cell_adhesion <- confusionMatrix(predictions,test_data$cell_adhesion_and_extracellular_matrix_responses)
...
# Evaluate the performance of the model on the testing set
performance_inflammation_and_immune <- confusionMatrix(predictions,test_data$inflammation_and_immune_responses)
...
# Evaluate the performance of the model on the testing set
performance_metal_ion <- confusionMatrix(predictions,test_data$metal_ion_responses)
...
# Evaluate the performance of the model on the testing set
performance_unfolded_protein <- confusionMatrix(predictions,test_data$unfolded_protein_responses_upr_and_endoplasmatic_reticulum_er_stress)
